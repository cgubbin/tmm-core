    ...
    R: Float + Debug,
{
    ...
    pub fn new(
        ...
        validate_finite("epsilon_infinity", epsilon_infinity)?;
    ...
    R: Float + Debug,
{
    ...
    where
        ...
        I: Sampled<Elem = R>,
    {
        vacuum_wavenumber.map(|k0| self.relative_permittivity_at::<C>(C::from_real(k0)))
    }
}
    ...
    R: Float + Debug,
{
    ...
    where
        ...
        I: Sampled<Elem = C>,
    {
        vacuum_wavenumber.map(|k0| self.relative_permittivity_at(k0))
    }
}
