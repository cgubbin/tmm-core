...
//         let exponent = ArrayJet1::from_parts(arr0(exponent_value), arr0(exponent_first));
...
//         let exponent = ArrayJet2::from_parts(
//             arr0(exponent_value),
//             arr0(exponent_first),
...
//         let kappa = ArrayJet1::from_parts(arr0(spectral_kappa(0.0)), arr0(c(0.3)));
...
//         let kappa = ArrayJet2::from_parts(arr0(spectral_kappa(0.0)), arr0(c(0.3)), arr0(c(0.1)));
...
//          */
//         let exponent =
//             ArrayJet1::from_parts(arr0(C::i() * kappa * c(thickness)), arr0(C::i() * kappa));
...
//         let kappa = ArrayJet1::from_parts(kappa_value, arr0(c(0.0)));
