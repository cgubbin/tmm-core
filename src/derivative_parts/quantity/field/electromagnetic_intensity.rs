use crate::{
    ...
    observable::ElectromagneticIntensities,
};

impl<J> IntoValue for ElectromagneticIntensities<J>
where
    J: IntoValue,
{
    type Value = ElectromagneticIntensities<J::Value>;

    fn into_value(self) -> ValuePart<Self::Value> {
        let (electric, magnetic) = self.into_parts();

        ValuePart::new(ElectromagneticIntensities::new(
...
impl<J> IntoFirst for ElectromagneticIntensities<J>
where
    J: IntoFirst,
{
    fn into_first(self) -> DirectionalFirstParts<Self::Value> {
        ...
        DirectionalFirstParts::new(
            ElectromagneticIntensities::new(electric_value, magnetic_value),
            ElectromagneticIntensities::new(electric_first, magnetic_first),
        )
    }
}

impl<J> IntoSecond for ElectromagneticIntensities<J>
where
    J: IntoSecond,
{
    fn into_second(self) -> DirectionalSecondParts<Self::Value> {
        ...
        DirectionalSecondParts::new(
            ElectromagneticIntensities::new(electric_value, magnetic_value),
            ElectromagneticIntensities::new(electric_first, magnetic_first),
            ElectromagneticIntensities::new(electric_second, magnetic_second),
        )
    }
}

impl<J> IntoBivariateFirst for ElectromagneticIntensities<J>
where
    J: IntoBivariateFirst,
{
    fn into_bivariate_first(self) -> BivariateFirstParts<Self::Value> {
        ...
        BivariateFirstParts::new(
            ElectromagneticIntensities::new(electric_value, magnetic_value),
            ElectromagneticIntensities::new(electric_axis0, magnetic_axis0),
            ElectromagneticIntensities::new(electric_axis1, magnetic_axis1),
        )
    }
}

impl<J> IntoBivariateSecond for ElectromagneticIntensities<J>
where
    J: IntoBivariateSecond,
{
    fn into_bivariate_second(self) -> BivariateSecondParts<Self::Value> {
        ...
        BivariateSecondParts::new(
            ...
            ElectromagneticIntensities::new(electric_axis0, magnetic_axis0),
            ElectromagneticIntensities::new(electric_axis1, magnetic_axis1),
            ElectromagneticIntensities::new(electric_axis0_axis0, magnetic_axis0_axis0),
            ElectromagneticIntensities::new(electric_axis0_axis1, magnetic_axis0_axis1),
            ElectromagneticIntensities::new(electric_axis1_axis1, magnetic_axis1_axis1),
        )
    }
}
...
mod decomposition_tests {
    ...
    use super::ElectromagneticIntensities;
    ...
    fn assert_intensities_eq(
        actual: &ElectromagneticIntensities<VectorField<C, D>>,
        electric_base: f64,
        magnetic_base: f64,
    ) {
    ...
    #[test]
    fn electromagnetic_intensities_into_value_extracts_both_vectors() {
        let fields = ElectromagneticIntensities::new(
        ...
        assert_intensities_eq(&value, 10.0, 20.0);
    }
    ...
    #[test]
    fn electromagnetic_intensities_into_first_preserves_e_and_h_parts() {
        let fields = ElectromagneticIntensities::new(
        ...
        assert_intensities_eq(&value, 10.0, 20.0);
        assert_intensities_eq(&first, 110.0, 120.0);
    }
    ...
    #[test]
    fn electromagnetic_intensities_into_second_preserves_all_orders() {
        let fields = ElectromagneticIntensities::new(
        ...
        assert_intensities_eq(&value, 10.0, 20.0);
        assert_intensities_eq(&first, 110.0, 120.0);
        assert_intensities_eq(&second, 210.0, 220.0);
    }
    ...
    #[test]
    fn electromagnetic_intensities_into_bivariate_first_preserves_axes() {
        let fields = ElectromagneticIntensities::new(
        ...
        assert_intensities_eq(&value, 10.0, 20.0);
        assert_intensities_eq(&axis0, 110.0, 120.0);
        assert_intensities_eq(&axis1, 210.0, 220.0);
    }
    ...
    #[test]
    fn electromagnetic_intensities_into_bivariate_second_preserves_all_components() {
        let fields = ElectromagneticIntensities::new(
        ...
        assert_intensities_eq(&axis0_axis0, 310.0, 320.0);

        assert_intensities_eq(&axis0_axis1, 410.0, 420.0);

        assert_intensities_eq(&axis1_axis1, 510.0, 520.0);
    }
}
