use crate::{
    ...
    observable::ConstitutiveFields,
};

impl<J> IntoValue for ConstitutiveFields<J>
where
    J: IntoValue,
{
    type Value = ConstitutiveFields<J::Value>;

    fn into_value(self) -> ValuePart<Self::Value> {
        let (electric, magnetic) = self.into_parts();

        ValuePart::new(ConstitutiveFields::new(
...
impl<J> IntoFirst for ConstitutiveFields<J>
where
    J: IntoFirst,
{
    fn into_first(self) -> DirectionalFirstParts<Self::Value> {
        ...
        DirectionalFirstParts::new(
            ConstitutiveFields::new(electric_value, magnetic_value),
            ConstitutiveFields::new(electric_first, magnetic_first),
        )
    }
}

impl<J> IntoSecond for ConstitutiveFields<J>
where
    J: IntoSecond,
{
    fn into_second(self) -> DirectionalSecondParts<Self::Value> {
        ...
        DirectionalSecondParts::new(
            ConstitutiveFields::new(electric_value, magnetic_value),
            ConstitutiveFields::new(electric_first, magnetic_first),
            ConstitutiveFields::new(electric_second, magnetic_second),
        )
    }
}

impl<J> IntoBivariateFirst for ConstitutiveFields<J>
where
    J: IntoBivariateFirst,
{
    fn into_bivariate_first(self) -> BivariateFirstParts<Self::Value> {
        ...
        BivariateFirstParts::new(
            ConstitutiveFields::new(electric_value, magnetic_value),
            ConstitutiveFields::new(electric_axis0, magnetic_axis0),
            ConstitutiveFields::new(electric_axis1, magnetic_axis1),
        )
    }
}

impl<J> IntoBivariateSecond for ConstitutiveFields<J>
where
    J: IntoBivariateSecond,
{
    fn into_bivariate_second(self) -> BivariateSecondParts<Self::Value> {
        ...
        BivariateSecondParts::new(
            ...
            ConstitutiveFields::new(electric_axis0, magnetic_axis0),
            ConstitutiveFields::new(electric_axis1, magnetic_axis1),
            ConstitutiveFields::new(electric_axis0_axis0, magnetic_axis0_axis0),
            ConstitutiveFields::new(electric_axis0_axis1, magnetic_axis0_axis1),
            ConstitutiveFields::new(electric_axis1_axis1, magnetic_axis1_axis1),
        )
    }
}
...
mod decomposition_tests {
    ...
    fn assert_fields_eq(
        actual: &ConstitutiveFields<VectorField<C, D>>,
        electric_base: f64,
        magnetic_base: f64,
    ) {
        assert_vector_eq(actual.electric_displacement(), electric_base);
        assert_vector_eq(actual.magnetic_induction(), magnetic_base);
    }
    ...
    #[test]
    fn constitutive_fields_into_value_extracts_both_vectors() {
        let fields = ConstitutiveFields::new(
    ...
    #[test]
    fn constitutive_fields_into_first_preserves_e_and_h_parts() {
        let fields = ConstitutiveFields::new(
    ...
    #[test]
    fn constitutive_fields_into_second_preserves_all_orders() {
        let fields = ConstitutiveFields::new(
    ...
    #[test]
    fn constitutive_fields_into_bivariate_first_preserves_axes() {
        let fields = ConstitutiveFields::new(
    ...
    #[test]
    fn constitutive_fields_into_bivariate_second_preserves_all_components() {
        let fields = ConstitutiveFields::new(
